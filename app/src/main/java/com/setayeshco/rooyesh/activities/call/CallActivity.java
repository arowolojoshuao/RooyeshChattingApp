...
import com.setayeshco.rooyesh.helpers.call.PeerConnectionParameters;
import com.setayeshco.rooyesh.helpers.call.WebRtcClient;
import com.setayeshco.rooyesh.models.calls.CallPusher;
...
public class CallActivity extends Activity {
            ...
            runOnUiThread(() -> {
                ...
                switch (bandwidthState) {
                    ...
                    case POOR:
                        ...
                        AppHelper.CustomToast(RooyeshApplication.getInstance(), getString(R.string.you_are_using_a_poor_connection));
                        new Handler().postDelayed(() -> {
                            connectionStatus.setVisibility(View.GONE);
                        }, 4000);
                        break;
    ...
    private void setTypeFaces() {
        if (AppConstants.ENABLE_FONTS_TYPES) {
            callTimer.setTypeface(AppHelper.setTypeFace(this, "IranSans"));
            callTitle.setTypeface(AppHelper.setTypeFace(this, "IranSans"));
            callStatus.setTypeface(AppHelper.setTypeFace(this, "IranSans"));
            connectionStatus.setTypeface(AppHelper.setTypeFace(this, "IranSans"));
