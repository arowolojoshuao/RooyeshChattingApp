...
import com.setayeshco.rooyesh.presenters.messages.MessagesPresenter;
...
/*
    ...
    *//**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        fragmentTransaction.add(R.id.frg_continer,new MessagesFragment());
    ...
    /*    drawer = (DrawerLayout) findViewById(R.id.main_activity);
      //  toggle = new ActionBarDrawerToggle(MessagesActivity.this, drawer, toolbar,0, 0);
