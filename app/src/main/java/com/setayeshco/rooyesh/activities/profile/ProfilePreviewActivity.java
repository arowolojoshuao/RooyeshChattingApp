...
import com.setayeshco.rooyesh.presenters.users.ProfilePreviewPresenter;
...
public class ProfilePreviewActivity extends Activity {
    ...
    private void setTypeFaces() {
        if (AppConstants.ENABLE_FONTS_TYPES) {
            userProfileName.setTypeface(AppHelper.setTypeFace(this, "IranSans"));
            actionProfileInvite.setTypeface(AppHelper.setTypeFace(this, "IranSans"));
        }
    }
