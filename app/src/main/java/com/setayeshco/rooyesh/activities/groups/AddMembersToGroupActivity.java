package com.setayeshco.rooyesh.activities.groups;
...
import com.setayeshco.rooyesh.adapters.recyclerView.groups.AddMembersToGroupAdapter;
import com.setayeshco.rooyesh.adapters.recyclerView.groups.AddMembersToGroupSelectorAdapter;
...
import com.setayeshco.rooyesh.presenters.groups.AddMembersToGroupPresenter;
...
public class AddMembersToGroupActivity extends AppCompatActivity implements RecyclerView.OnItemTouchListener, View.OnClickListener, NetworkListener {
    ...
    private void setupToolbar() {
        ...
        String title = String.format(" %s " + getResources().getString(R.string.selected) + " %s " + getResources().getString(R.string.of), mAddMembersToGroupListAdapter.getSelectedItemCount(), mAddMembersToGroupListAdapter.getContacts().size());
