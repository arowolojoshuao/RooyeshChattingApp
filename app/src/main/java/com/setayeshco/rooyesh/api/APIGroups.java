...
public interface APIGroups {
    ...
    Observable<GroupResponse> createGroup(@Part("userID") int userID,
    ...
    /**
     * method to remove a member an admin
     *
     * @param groupID this is the first parameter for  makeAdmin method
     * @param id      this is the second parameter for  makeAdmin method
     * @return this is return value
    ...
    Call<GroupResponse> removeAdmin(@Part("groupID") int groupID,
                                    @Part("id") int id);


    /**
     * method is presen or absent a member
     *
     * @param groupID this is the first parameter for  presents or absents group
     * @param presentId      this is the second parameter for  present method
     * @param absentId      this is the second parameter for  absent method
     * @return this is return value
     */
    @Multipart
    @POST(EndPoints.IS_PRESENT)
    Call<GroupResponse> isPresent(@Part("groupID") int groupID,
                                  @Part("presentId") ArrayList<Integer> presentId,
                                  @Part("absentId") ArrayList<Integer> absentId,
                                  @Part("date") String date);
     ...
     *
     * @param groupID this is the first parameter for  presents or absents group
     * @param userId      this is the second parameter for  present method
     * @return this is return value
     */
    @Multipart
    @POST(EndPoints.IS_PRESENT_SEARCH)
    Call<GroupResponse> isPresentSearch(@Part("groupID") int groupID,
    ...
    @GET(EndPoints.PRESENT_LIST_GROUP)
    Call<List<GroupPresent>> listPresentGroup(@Path("groupID") String groupID,@Path("date") int date);

    @GET(EndPoints.UPDATE_PRESENT_LIST_GROUP)
    Call<List<GroupPresent>> updateListPresentGroup(@Path("pID") String pID,@Path("state") String state);
}
