...
import com.setayeshco.rooyesh.animations.IndicatorAnimation;
...
public class LoadingIndicatorView extends View {
    ...
    private static final CirclePulseIndicator DEFAULT_INDICATOR = new CirclePulseIndicator();
    ...
    private IndicatorAnimation mIndicator;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mIndicatorColor = a.getColor(R.styleable.LoadingIndicatorView_indicatorColor, AppHelper.getColor(context, R.color.colorSlideIndicator));
    ...
    public IndicatorAnimation getIndicator() {
        return mIndicator;
    }

    public void setIndicator(IndicatorAnimation d) {
        if (mIndicator != d) {
            if (mIndicator != null) {
    ...
    public void setIndicator(String indicatorName) {
        ...
        try {
            ...
            IndicatorAnimation indicator = (IndicatorAnimation) drawableClass.newInstance();
