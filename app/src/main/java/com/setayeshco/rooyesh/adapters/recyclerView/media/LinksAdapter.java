    ...
    public class LinksViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
                    ...
                    if (messagesModel.getMessage() != null) {
                        if (UtilsString.checkForUrls(messagesModel.getMessage())) {
                            ...
                            if (sourceContent.getImages().size() > 0) {
                                ...
                                RooyeshImageLoader.loadSimpleImage(mActivity, sourceContent.getImages().get(0), target, null, AppConstants.MESSAGE_IMAGE_SIZE);
        ...
        private void setTypeFaces() {
            if (AppConstants.ENABLE_FONTS_TYPES) {
                titleLink.setTypeface(AppHelper.setTypeFace(mActivity, "IranSans"));
                descriptionLink.setTypeface(AppHelper.setTypeFace(mActivity, "IranSans"));
                urlLink.setTypeface(AppHelper.setTypeFace(mActivity, "IranSans"));
            }
        }
