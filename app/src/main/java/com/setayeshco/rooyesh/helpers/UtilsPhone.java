...
import com.setayeshco.rooyesh.interfaces.ContactMobileNumbQuery;
...
public class UtilsPhone {
    ...
    public static ArrayList<ContactsModel> GetPhoneContacts() {
        ContentResolver contentResolver = RooyeshApplication.getInstance().getApplicationContext().getContentResolver();
