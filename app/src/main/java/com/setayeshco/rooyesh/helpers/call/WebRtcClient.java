...
public class WebRtcClient {
    ...
    public void signalingServer(String to, String type, JSONObject payload) throws JSONException {
        ...
        message.put("to", to);
        message.put("from", PreferenceManager.getSocketID(RooyeshApplication.getInstance()));
            ...
            try {
                ...
                mSocket.emit(AppConstants.SOCKET_RESET_SOCKET_ID, message, (Ack) args -> {
                    ...
                    try {
                        ...
                        if (!id.equals(PreferenceManager.getSocketID(RooyeshApplication.getInstance()))) {
                            mActivity.finish();
                        } else {
